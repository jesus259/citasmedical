...
include ("../controlador/conexion.php");
 ...
 echo "<br></br>";
  //tabla de doctores
$querydoc=$conn->query("SELECT * FROM doctores");
 echo "<table border=1>";
 echo "<tr>";
 echo "<th colspan=7>Data de Doctores</th>";
 echo "</tr>";
 echo "<tr><th>ID</th><th>Cedula</th><th>Nombre</th><th>Apellido</th><th>Atiende</th><th>Horario</th><th>Dias asignados</th></tr>";
